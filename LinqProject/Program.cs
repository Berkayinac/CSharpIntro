...
List<Product> products = new List<Product>()
{
    ...
    new Product{ProductId = 2, CategoryId = 1, ProductName = "Asus Laptop", QuantityPerUnit = "16 GB Ram", UnitPrice = 8000, UnitsInStock = 5},
...
// p-> product, p=>p.UnitPrice -> her bir product için Unitprice > 5000
var result = products.Where(p => p.UnitPrice > 5000);
var resultV2 = products.Where(p => p.UnitPrice > 5000 && p.UnitsInStock > 3);
